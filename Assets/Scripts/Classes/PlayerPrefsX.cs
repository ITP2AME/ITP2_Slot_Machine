...
/// 
/// Modified to use PreviewLabs.PlayerPref instead of Unity for better performance, and encrytion.
/// Modified Bool / Long functions to take newer default functions of previewlabs.
/// Added Float / Int / String wrapper to allow one clas to access all saving.
/// Commented out SplitLong Function.
/// </summary>
/// CHANGELOG: 
...
public class PlayerPrefsX
{
	...
	{
		return PreviewLabs.PlayerPrefs.GetBool(name);
	}
	
	public static bool GetBool (String name, bool defaultValue)
	{
		return PreviewLabs.PlayerPrefs.GetBool(name, defaultValue);
	}
	
	public static long GetLong(String key, long defaultValue)
	{
		return PreviewLabs.PlayerPrefs.GetLong(key, defaultValue);
	}
	
	public static long GetLong(String key)
	{
		return PreviewLabs.PlayerPrefs.GetLong(key);
	}
	
	public static int GetInt(String key, int defaultValue)
	{
		return PreviewLabs.PlayerPrefs.GetInt(key, defaultValue);
	}
	
	public static int GetInt(String key)
	{
		return PreviewLabs.PlayerPrefs.GetInt(key);
	}
	
	public static float GetFloat(String key, float defaultValue)
	{
		return PreviewLabs.PlayerPrefs.GetFloat(key, defaultValue);
	}
	
	public static float GetFloat(String key)
	{
		return PreviewLabs.PlayerPrefs.GetFloat(key);
	}
	
	public static String GetString(String key, String defaultValue)
	{
		return PreviewLabs.PlayerPrefs.GetString(key, defaultValue);
	}
...
//	}
	...
	{
		PreviewLabs.PlayerPrefs.SetBool(name, value);
	}

	public static void SetLong(String key, long value)
	{
		PreviewLabs.PlayerPrefs.SetLong(key, value);
	}
	
	public static void SetInt(String key, int value)
	{
		PreviewLabs.PlayerPrefs.SetInt(key, value);
	}
	
	public static void SetFloat(String key, float value)
	{
		PreviewLabs.PlayerPrefs.SetFloat(key, value);
	}
	...
	public static bool[] GetBoolArray (String key)
	{
		if (PreviewLabs.PlayerPrefs.HasKey(key))
		{
			var bytes = System.Convert.FromBase64String (PreviewLabs.PlayerPrefs.GetString(key));
			if (bytes.Length < 5)
			{
	...
	public static bool SetStringArray (String key, String[] stringArray)
	{
		...
		try
		{
			PreviewLabs.PlayerPrefs.SetString (key, System.Convert.ToBase64String (bytes) + "|" + String.Join("", stringArray));
		}
		catch
		{
			return false;
	...
	{
		if (PreviewLabs.PlayerPrefs.HasKey(key)) {
			var completeString = PreviewLabs.PlayerPrefs.GetString(key);
	...
	private static bool SaveBytes (String key, byte[] bytes)
	{
		try
		{
			PreviewLabs.PlayerPrefs.SetString (key, System.Convert.ToBase64String (bytes));
		}
		catch
		{
			return false;
